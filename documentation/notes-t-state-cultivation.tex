...
%	\end{equation*}
	...
	\begin{figure}[h!]
		...
		\begin{quantikz}[row sep={0.85cm, between origins}, column sep={0.3cm}]
			...
			& &&&\targ{}&&\ctrl{-1} & \meter{\scalebox{0.5}{\Op{X}}} &\setwiretype{n}&
			\\
			% Data qubit 7
			...
			& &&\phantom{i}&&&\ctrl{-1}& \meter{\scalebox{0.5}{\Op{X}}} & \setwiretype{n} &
			\\
			% Data qubit 2
			...
			& &&\phantom{i}&\targ{}&&\ctrl{-1}& \meter{\scalebox{0.5}{\Op{X}}} &\setwiretype{n}&
			\\
			% Data qubit 3
			...
			& &\targ{}&\ctrl{2}&&\ctrl{-1}&\ctrl{1}& \meter{\scalebox{0.5}{\Op{X}}} &\setwiretype{n}&
			\\
			% Data qubit 5
