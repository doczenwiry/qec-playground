...
\title{TQEC --- Notes on T-state cultivation\thanks{Based on Austin Fowler's presentation of \texorpdfstring{\href{https://arxiv.org/abs/arXiv:2510.24615}{arXiv:2510.24615}}{arXiv:2510.24615} and \texorpdfstring{\href{https://arxiv.org/abs/2510.24615}{arXiv:2409.17595}}{arXiv:2409.17595} at TQEC meeting on 2026/08/12.}}
	...
	\begin{figure}[h!]
		...
		\begin{subfigure}[c]{0.32\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[quantumY, line width=2.5pt] (C) circle (6.5pt);
			\end{tikzpicture}
		\end{subfigure}
		\begin{subfigure}[c]{0.62\textwidth}
			...
			\begin{quantikz}[row sep=0.6cm]
				...
				& \targ{}  & \targ{}  & \gate[style={fill=quantumY}]{\Op{T}^{\dagger}} & \targ{} & \targ{} &
			\end{quantikz}
		\end{subfigure}
...
%	\end{equation*}
	...
	{\bf Careful:} the $\Op{S}$ gate is transversal in the Steane Code but the $\Op{T}$ gate is not.
