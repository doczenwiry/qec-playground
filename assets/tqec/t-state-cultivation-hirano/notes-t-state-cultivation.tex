...
%	\end{equation*}
	...
	\begin{figure}[h!]
		...
		\begin{tikzpicture}
			...
			\node[meas] at ( 5, -5) {};
		\end{tikzpicture}
		\caption{Modified Steane Code overlaid on the surface code array. Data qubits are identified as black circles. Measurement qubits are shown as white circles. The extra qubits can be used for syndrome measurement in the injection stage and checking the phase in the cultivation stage.}
	\end{figure}
