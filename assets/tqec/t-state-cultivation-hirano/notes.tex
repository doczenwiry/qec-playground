...
\begin{document}
	...
	In order to prepare a 7-qubits magic state, the following modified Steane Code circuit\footnote{Based on the circuit from Figure 6 in arXiv:2409.17595} is used where a \Op{T}-gate\footnote{Or an \Op{S}-gate to enable simulation of the resulting circuit that the non-Clifford \Op{T}-gate prevents} has been strategically placed to inject the $\frac{\pi}{4}$ phase onto the $\kett{1}_{\scriptscriptstyle L}$ component of the $\kett{+}_{\scriptscriptstyle L}$ state.
