...
\tikzstyle{interact}=[line width=2pt, shorten <= 8pt, shorten >= 12pt, -stealth]
\tikzstyle{partner}=[line width=2pt, shorten <= 8pt, shorten >= 12pt, stealth-stealth]

\tikzstyle{entanglement}=[decorate,decoration={snake,pre length=2.5mm,post length=2.5mm,amplitude=0.5mm,segment length=2.5mm}]
\tikzstyle{entanglementlong}=[decorate,decoration={snake,pre length=5mm,post length=2.5mm,amplitude=0.5mm,segment length=2.5mm}]
\tikzstyle{entanglementlower}=[decorate,decoration={snake,pre length=5mm,post length=3mm,amplitude=0.5mm,segment length=2.5mm}]
...
%					-- (8, -6) -- cycle;
%	
%				\fill[quantumB, opacity=0.35] (2,-4) -- (4, -4) -- (4, -6) -- (2, -6);
%				\filldraw[quantumB, opacity=0.35] (-2,-4) to[bend left=30] (0,-6) to[bend left=30] (-2,-4);
%	
%	
