...
if __name__ == "__main__":
    ...
    draw_plaquettes(
        junction, regular_schedules, twobody_schedules, extended_schedules,
        direction = 'forward', savefile='schedule-forward.png'
    )
    draw_plaquettes(
        junction, regular_schedules, twobody_schedules, extended_schedules,
        direction = 'reverse', savefile='schedule-reverse.png'
    )
