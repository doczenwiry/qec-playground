...
all_schedules = {
    'forward': {
        ...
        16: [0, 2, 3, 5], 17: [1, 0, 3, 5], 18: [1, 4, 0, 5], 19: [1, 2, 3, 0]
    },
    'reverse': {
        1 : [5, 3, 4, 1], 2 : [5, 3, 2, 1], 5 : [5, 3, 4, 1], 6 : [5, 3, 2, 1],
        8 : [0, 0, 2, 1], 9 : [5, 0, 4, 0], 10: [5, 3, 0, 0], 11: [0, 3, 0, 1],
        12: [5, 3, 4, 2], 13: [5, 3, 4, 2], 14: [0, 3, 4, 2], 15: [5, 3, 4, 0],
        16: [0, 3, 2, 1], 17: [5, 0, 4, 1], 18: [5, 3, 0, 1], 19: [5, 3, 2, 0]
    }
}
...
if __name__ == "__main__":
    ...
    draw_plaquettes(
        junction, all_schedules, direction = 'forward', savefile='../assets/tqec/tqec-extended-stabilizers-rotating-spatial-forward.png'
    )
    draw_plaquettes(
        junction, all_schedules, direction = 'reverse', savefile='../assets/tqec/tqec-extended-stabilizers-rotating-spatial-reverse.png'
    )
    ...
    circuit_file = "../assets/tqec/tqec-extended-stabilizers-rotating-spatial.stim"
    ...
    with open("../assets/tqec/tqec-extended-stabilizers-rotating-spatial.stim", "w", encoding="utf-8") as file:
