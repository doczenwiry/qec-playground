...
if __name__ == "__main__":
    ...
    circuit_file = "../assets/tqec/extended-stabilizers/tqec-extended-stabilizers-rotating-spatial.stim"
    ...
    with open("../assets/tqec/extended-stabilizers/tqec-extended-stabilizers-rotating-spatial.stim", "w", encoding="utf-8") as file:
