...
if __name__ == "__main__":
    ...
    circuit_file = "../assets/tqec/tqec-extended-stabilizers-flipping-temporal.stim"
    ...
    with open("../assets/tqec/tqec-extended-stabilizers-flipping-temporal.stim", "w", encoding="utf-8") as file:
