...
all_schedules = {
    'forward': {
        ...
        16: [0, 0, 3, 5], 17: [1, 0, 3, 0], 18: [1, 2, 0, 0], 19: [0, 4, 0, 5]
    },
    'reverse': {
        0: [5, 3, 2, 1], 1: [4, 1, 5, 3],  2: [2, 1, 5, 3],  3: [1, 4, 3, 5],
        4: [5, 3, 2, 1], 5: [4, 1, 5, 3],  6: [2, 1, 5, 3],  7: [1, 4, 3, 5],
        8: [0, 0, 5, 3], 9: [4, 0, 5, 0], 10: [2, 1, 0, 0], 11: [0, 1, 0, 3],
        12: [4, 2, 5, 3], 13: [4, 2, 5, 3], 14: [0, 2, 5, 3], 15: [4, 2, 5, 0],
        16: [0,0,5,3], 17: [4,0,5,0], 18: [2,1,0,0], 19: [0,1,0,3]
    }
}
...
def print_schedules():
    for ptype in all_schedules['forward'].keys():
        ...
        print(f"{plaquettes[encoding[ptype]]} [{hex(ptype)[2:]}] :\n{pretty_schedules(forward, reverse)}")
...
if __name__ == "__main__":
    ...
    with open("../assets/tqec/extended-stabilizers/tqec-extended-stabilizers-flipping-temporal.stim", "w", encoding="utf-8") as file:
